...
`prior_decision: {finding, iri, outcome, severity, decided_at, note}` on the json
row, "a like claim on this line was declined 2026-09-21: <reason>" on the card —
...
fresh finding to the decision node of a declined twin on the same line), plus
